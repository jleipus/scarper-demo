...
const (
	Parser_ParsePage_FullMethodName = "/Parser/ParsePage"
)
...
type ParserClient interface {
	ParsePage(ctx context.Context, in *RawPageData, opts ...grpc.CallOption) (*ParsedPageResponse, error)
}
...
func (c *parserClient) ParsePage(ctx context.Context, in *RawPageData, opts ...grpc.CallOption) (*ParsedPageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ParsedPageResponse)
	err := c.cc.Invoke(ctx, Parser_ParsePage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ParserServer interface {
	ParsePage(context.Context, *RawPageData) (*ParsedPageResponse, error)
...
func (UnimplementedParserServer) ParsePage(context.Context, *RawPageData) (*ParsedPageResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ParsePage not implemented")
}
...
func _Parser_ParsePage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RawPageData)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ParserServer).ParsePage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Parser_ParsePage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ParserServer).ParsePage(ctx, req.(*RawPageData))
	}
...
var Parser_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ParsePage",
			Handler:    _Parser_ParsePage_Handler,
		},
	},
